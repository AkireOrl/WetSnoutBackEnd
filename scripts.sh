...
npx typeorm migration:create ./src/database/migrations/CreateDogs
npx typeorm migration:create ./src/database/migrations/CreateActivity
...
npx typeorm entity:create ./src/models/Role
npx typeorm entity:create ./src/models/User
npx typeorm entity:create ./src/models/Dog
npx typeorm entity:create ./src/models/Activity
